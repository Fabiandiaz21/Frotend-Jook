  ...
  <div class="cart-container">
    ...
    <div v-else>
      ...
      <div class="cart-summary">
        ...
        <p class="total-price">
          Total a pagar: <strong>${{ cartStore.totalPrice.toFixed(2) }}</strong>
        </p>
